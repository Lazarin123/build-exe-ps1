...
# 5. Gerar executável para Mac (x64 / arm64)
mkdir -p bin
echo -e "\033[0;32mGerando executável para macOS...\033[0m"
npx pkg "$ENTRY_POINT" --targets node18-macos-x64 --output "bin/app-macos"

if [ -f "bin/app-macos" ]; then
    echo -e "\n\033[0;32mExecutável gerado com sucesso em: $PROJECT_PATH/bin/app-macos\033[0m"
else
